...
class TFGCommandActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TFGCommandGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TFGCommandActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TFGCommandGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TFGCommandGoal()
    }
...
module.exports = TFGCommandActionGoal;
