...
let ParallelSpinPadsGripperCommandResult = require('./ParallelSpinPadsGripperCommandResult.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class ParallelSpinPadsGripperCommandActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ParallelSpinPadsGripperCommandResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ParallelSpinPadsGripperCommandResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ParallelSpinPadsGripperCommandActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = ParallelSpinPadsGripperCommandResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ParallelSpinPadsGripperCommandResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ParallelSpinPadsGripperCommandActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ParallelSpinPadsGripperCommandResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ParallelSpinPadsGripperCommandResult()
    }
...
module.exports = ParallelSpinPadsGripperCommandActionResult;
