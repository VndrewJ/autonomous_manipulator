...
class GripperCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GripperCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GripperCommandActionFeedback(null);
    ...
    data.feedback = GripperCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GripperCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GripperCommandFeedback()
    }
...
module.exports = GripperCommandActionFeedback;
