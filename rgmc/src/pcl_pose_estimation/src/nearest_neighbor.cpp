...
int main(int argc, char** argv) {
    ...
    pcl::console::print_value("%d", k); pcl::console::print_info(" nearest neighbors.\n");
    ...
    for (int i = 0; i < k; ++i) {
        ...
        // Load the recognized object point cloud
        ...
        if (cloud_xyz.size() == 0) continue;

        // Compute the centroid of the recognized object
        ...
        p.addPointCloud<pcl::PointXYZ>(cloud_xyz.makeShared(), cloud_name);
        p.addCoordinateSystem(0.1, "object_frame", 0);
