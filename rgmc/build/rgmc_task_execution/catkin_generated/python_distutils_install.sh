...
echo_and_run cd "/home/akoh751/autonomous_assembly_robot/rgmc/src/rgmc_task_execution"
...
echo_and_run /usr/bin/env \
    ...
    "/home/akoh751/autonomous_assembly_robot/rgmc/src/rgmc_task_execution/setup.py" \
     \
    build --build-base "/home/akoh751/autonomous_assembly_robot/rgmc/build/rgmc_task_execution" \
    install \
    --root="${DESTDIR-/}" \
