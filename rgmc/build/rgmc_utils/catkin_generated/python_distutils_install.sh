...
echo_and_run cd "/home/akoh751/autonomous_assembly_robot/rgmc/src/rgmc_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/home/akoh751/autonomous_assembly_robot/rgmc/src/rgmc_utils/setup.py" \
     \
    build --build-base "/home/akoh751/autonomous_assembly_robot/rgmc/build/rgmc_utils" \
    install \
    --root="${DESTDIR-/}" \
